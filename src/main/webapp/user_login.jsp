...
<div class="card-body">
<p class="fs-4 text-center" style="color:green">User Login</p>
...
<form action="user_login" method="post">
 ...
 <a href="register.jsp"  class="btn btn-warning text-white col-md-12 mt-2"><i class="fa-solid fa-pen-to-square"></i> Register</a>
</form>
</div>
</div>
</div>
